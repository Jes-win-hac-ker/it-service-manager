...
const SearchReports: React.FC = () => {
  ...
  const openEditModal = (report: Report) => {
    ...
    setFormData({
      ...
      part_number: report.part_number || '', // Add part_number to form state
    });
  };
            ...
            <form onSubmit={handleUpdate} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input name="part_number" value={formData.part_number || ''} onChange={handleInputChange} className="w-full p-2 border rounded-lg mt-1"/>
                </div>
                <div>
